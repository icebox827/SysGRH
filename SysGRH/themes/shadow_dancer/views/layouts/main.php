...
<div class="container" id="page">
	<div id="topnav">
		<div class="topnav_text"><a href='<?php echo Yii::app()->theme->baseUrl; ?>/site/index.php'>Acceuil</a> | <a href='<?php echo Yii::app()->theme->baseUrl; ?>/site/login.php'>Mon Compte</a> | <a href='#'>Parametres</a> | <a href='#'>Deconnexion</a> </div>
	</div>
	<div id="header">
...
<?php /*$this->widget('application.extensions.mbmenu.MbMenu',array(
	...
	<div id="footer">
		Copyright &copy; <?php echo date('Y'); ?> Police Nationale d'Haiti<br/>
